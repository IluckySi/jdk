...
public class AttachProviderImpl extends HotSpotAttachProvider {
    ...
    {
        System.out.println("Ilucky....AttachProviderImpl...vimd="+vmid); // Ilucky....AttachProviderImpl...vimd=385695
        checkAttachPermission();

        // AttachNotSupportedException will be thrown if the target VM can be determined
        // to be not attachable.
        testAttachable(vmid);  // TODO: test attachable(1.4 & 5.0 not support)
